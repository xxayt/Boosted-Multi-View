...
from models.baseline_model import ExponentialLoss, Baseline_Concat
...
def main(args):
    ...
    # model = Baseline_Concat(num_classes=args.num_classes, feature_dim=sum(Views_dim.values()))
    model = Baseline_Concat(num_classes=args.num_classes, feature_dim=12*(Views_dim['cenhist']))
    # model = Baseline_Concat(num_classes=args.num_classes, feature_dim=60*(Views_dim['gabor']))
